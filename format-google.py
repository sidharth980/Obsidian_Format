...
class ObsidianVaultOrganizer:
    ...
    def get_organization_suggestions(self) -> Dict:
        """
        Send the file index to Gemini and get organization suggestions.
        
        Returns:
            Dictionary with the new organization structure
        """
        print("Getting organization suggestions from Gemini...")
...
Only return valid JSON, no other text."""
    ...
    def reorganize_vault(self, organization_plan: Dict):
        """
        Reorganize the vault based on Gemini's suggestions.
    ...
    def run(self, create_backup: bool = True):
        ...
        # Step 3: Get organization suggestions from Gemini
...
def main():
    parser = argparse.ArgumentParser(description="Organize your Obsidian vault using Google Gemini AI")
